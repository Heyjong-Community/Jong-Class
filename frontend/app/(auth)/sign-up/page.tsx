  ...
  return (
    <div className='w-full min-h-screen grid grid-cols-1 md:grid-cols-2'>
      <div className='relative w-full bg-primary overflow-hidden p-16 flex flex-col justify-between'>
        ...
        <div className='border border-border rounded-xl p-8 flex items-start gap-4'>
      ...
      <div className='bg-[#F8F9FF] w-full h-full overflow-hidden p-16'>
        <h2 className='xl:text-4xl text-primary font-bold'>Registrasi Akun</h2>
        <p className='mt-2 text-base text-[#45474A]'>Elevate your engineering career today.</p>
        ...
        <div className='my-6 flex items-center gap-4'>
          ...
          <p className='text-xs uppercase text-[#45474A] font-medium'>atau daftar dengan email</p>
          <div className='grow border-t-2 border-border'></div>
        </div>
        <form className='mt-8 space-y-5'>
          ...
          <div className='space-y-2'>
            <Label className='text-sm font-semibold text-primary'>Konfirmasi Password</Label>
            <Input type='password' placeholder='******' />
          </div>
          <div className=''>
        ...
        <div className='mt-12'>
          <p className='text-xs text-center text-[#45474A]/40 font-medium'>
